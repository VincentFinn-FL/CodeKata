package com.example.javakotlinkata.adventofcode.vince
...
class AdventOfCode {
    ...
    fun `find two numbers that add up to target`() {
        ...
        val actual = findTwoEntriesThatSumToTarget(toArray(input), target)
    ...
    fun `find three numbers that add up to target`() {
        ...
        val actual = findThreeEntriesThatSumToTarget(toArray(input), target)
